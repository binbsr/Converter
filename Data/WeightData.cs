...
namespace Converter.Data
{
    ...
    {   
        // Taking inch as base
        public Dictionary<string, (string NepaliUnicode, string ShortForm, string Details, double RatioToBase)> AvailableUnits => new Dictionary<string, (string, string, string, double)>
        {   
